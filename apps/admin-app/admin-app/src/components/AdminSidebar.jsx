...
export default function AdminSidebar() {
  return (
    <aside className="h-screen w-64 bg-gradient-to-b from-blue-800 via-purple-800 to-pink-700 text-white flex flex-col shadow-2xl fixed top-0 left-0 z-40">
      <div className="text-2xl font-extrabold tracking-wide px-8 py-6 mb-4 border-b border-white/10">SkillSwap Admin</div>
